           ...
           <div className="col-auto header_logo_left_space">
              <div className="d-flex items-center">
                <Link href="/" className="header-logo mr-20">
                  ...
                  {
                    isLoading ? (<Image unoptimized quality={100} style={{width : "60px", height:"60px"}} src="/img/logo_loading.webp" width={128} height={128}alt="Hajj, Umrah and Ziarah"/>) :(<Image quality={100} style={{width : "60px", height:"60px"}} src={logoUrl} width={128} height={128} alt="Hajj, Umrah and Ziarah"/>)
                  }
                </Link>
                {/* End logo */}
                {/* <HeaderSearch /> */}
            ...
            <div className="col-auto">
              ...
              <a className="btn-whatsapp-pulse whatsapp_icon" href="https://api.whatsapp.com/send/?phone=966548037409&amp;text=Hi DreamZiarah, I need assistance&amp;type=phone_number&amp;lang=en" target="_blank">
              <Image style={{cursor : "pointer"}} src="/img/whatsapp.svg" width={30} height={30}/>
              </a>
              {/* <HeaderSearch /> */}
