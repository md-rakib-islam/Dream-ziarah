  ...
  return (
    ...
    <div  className="d-flex justify-end js-pin-content">
      <div  className="w-360 lg:w-full d-flex flex-column items-center">
        <div  className="bokunWidget" data-src="https://widgets.bokun.io/online-sales/d894d0d4-5eab-4e15-821d-6770f0186810/experience-calendar/830933"></div>
      </div>
...
export default UmrahSidebarRight;
