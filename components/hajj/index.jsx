...
const Hajj = ({children}) => {
  ...
  const {data : itenarayItems, isSuccess: isItenariesSuccess} = useGetItenariesByMenuContentIdQuery(40);
  const {data : imageContents, isSuccess: isImageContentsSuccess} = useGetImagesByMenuIdQuery(hajjId);
