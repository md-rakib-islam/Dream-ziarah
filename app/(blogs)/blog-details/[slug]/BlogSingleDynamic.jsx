...
const BlogSingleDynamic = ({ params }) => {
  ...
  return (
    <>
      ...
      {
        isLoading && isBlogDetailsLoading ? (<div style={{width: "1200px", display:"flex", justifyContent:"center", alignItems:"center"}}><Loading/></div>) : (<section className="layout-pt-md layout-pb-md">
        <div className="container">
          <div className="row y-gap-40 justify-center text-center">
            <div className="col-auto">
              ...
              <div className="text-15 text-light-1 mt-10">{blogItem?.date}</div>
            </div>
